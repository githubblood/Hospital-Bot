...
// Stored under backend/uploads (runtime-written, not part of the git-tracked
// frontend/ source tree) and served via the dedicated /admin/uploads static
// mount in app.js. Filename is a random token, not the hospital's id, since
// the hospital row doesn't exist yet at upload time (registration is one
// multipart request: file + fields together, hospital created only after the
