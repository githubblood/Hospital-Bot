...
const { isValidEmail, isValidPhone, isStrongEnoughPassword, cleanOptional, isNonEmpty } = require('../utils/validators');
...
// actions (see db/schema.sql's comment on platform_audit_log) — exactly one
